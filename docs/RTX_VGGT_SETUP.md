...
## 17. 현황 (2026-09-04 밤) — 질의 프레임 모드는 확정, 접히는 집은 미해결
HSSD house_0000: 질의 프레임 33장만 국소화한 벤치 = 978장 등록 벤치(0.818 동일). **14절 모드가 기본.**
접히던 house_0012: VGGT(392 px·지도 96장)로 카메라방 0.50(COLMAP 0.36~0.45). 채택선 0.8 미달 — RTX 의 518 px·전체 지도 결과가
판정. 15절 절차 그대로, 접히는 채(질감 많은 집) 한 채를 꼭 포함해 달라.
